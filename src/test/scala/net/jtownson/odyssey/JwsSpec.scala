...
class JwsSpec extends FlatSpec {
  ...
  it should "be consistent with the example at https://tools.ietf.org/html/rfc7515#appendix-A.1" in {
    ...
    Jws.signingInput(protectedHeader, payload).toSeq shouldBe Seq[Byte](101, 121, 74, 48, 101, 88, 65, 105, 79, 105,
      ...
      57, 112, 99, 49, 57, 121, 98, 50, 57, 48, 73, 106, 112, 48, 99, 110, 86, 108, 102, 81)
